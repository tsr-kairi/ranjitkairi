...
const SkillsSection = () => {
  ...
  const technicalSkills = {
    frontend: [
      ...
      { name: 'Next.js (App & Pages Router)', level: 94, color: 'from-gray-200 to-gray-400' },
      ...
      { name: 'Material UI / Mantine', level: 88, color: 'from-indigo-400 to-purple-500' },
      { name: 'HTML5 / CSS3 / Core Web Vitals', level: 96, color: 'from-orange-400 to-red-500' },
    ],
    backend: [
      { name: 'Node.js', level: 85, color: 'from-green-500 to-emerald-400' },
      { name: 'Express.js', level: 82, color: 'from-gray-300 to-gray-500' },
      { name: 'Nest.js', level: 80, color: 'from-red-500 to-rose-400' },
      { name: 'MongoDB', level: 80, color: 'from-green-600 to-green-400' },
      { name: 'Prisma ORM', level: 82, color: 'from-teal-400 to-cyan-500' },
      { name: 'RESTful APIs & Integration', level: 92, color: 'from-indigo-400 to-purple-500' },
      { name: 'Zod & Schema Validation', level: 86, color: 'from-blue-500 to-indigo-500' },
    ],
    cms: [
      { name: 'WordPress & Custom Themes', level: 88, color: 'from-blue-500 to-blue-700' },
      { name: 'Elementor Pro', level: 86, color: 'from-pink-400 to-rose-500' },
      { name: 'SCSS / SASS', level: 90, color: 'from-pink-500 to-purple-500' },
      { name: 'Responsive Mobile-First UI', level: 96, color: 'from-purple-500 to-indigo-500' },
      { name: 'Component Design Systems', level: 92, color: 'from-emerald-400 to-teal-500' },
    ],
    ai: [
      { name: 'AI Automation Workflows', level: 92, color: 'from-purple-400 to-pink-500' },
      { name: 'WhatsApp Business API', level: 90, color: 'from-green-500 to-emerald-400' },
      ...
      { name: 'Prompt Engineering & AI Tools', level: 88, color: 'from-pink-400 to-rose-500' },
    ],
    tools: [
      { name: 'Git & GitHub', level: 92, color: 'from-orange-500 to-red-500' },
      { name: 'Docker', level: 80, color: 'from-blue-500 to-cyan-400' },
      { name: 'AWS (S3 / CloudFront)', level: 82, color: 'from-amber-500 to-yellow-400' },
      { name: 'Vite / Webpack', level: 88, color: 'from-purple-500 to-indigo-500' },
      { name: 'Vercel / Netlify Deployments', level: 90, color: 'from-gray-200 to-gray-400' },
